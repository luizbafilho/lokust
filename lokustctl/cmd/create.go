...
func buildLocustTest(name string, namespace string) (testsv1beta1.LocustTest, error) {
	replicas := int32(1)
	test := testsv1beta1.LocustTest{
		TypeMeta: metav1.TypeMeta{APIVersion: testsv1beta1.GroupVersion.String(), Kind: "LocustTest"},
		ObjectMeta: metav1.ObjectMeta{
			Name:      name,
			Namespace: namespace,
		},
		Spec: testsv1beta1.LocustTestSpec{
